...
@section('title', 'Rangking Produk | Ethica')
@section('content')
<div class="card">
    @include('flash-message')
    <div class="card-header">
        <h1 class="card-title" style="float: left; font-size: 20pt">Rangking Produk</h3>
    ...
    <form id="penjualan" class="form-horizontal" method="get" action="{!! route('lap_perbandingan_po_vendor') !!}">
        ...
        <div class="card-body">
            ...
            <div class="card-footer">
                <a href="{!! route('rangking_produk') !!}" class="btn btn-danger btn-sm"><span class="fa fa-times"></span> Reset</a>

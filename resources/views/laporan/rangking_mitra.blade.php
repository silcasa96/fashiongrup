...
@section('title', 'Rangking Mitra | Ethica')
@section('content')
<div class="card">
    @include('flash-message')
    <div class="card-header">
        <h1 class="card-title" style="float: left; font-size: 20pt">Rangking Mitra</h3>
    ...
    <form id="penjualan" class="form-horizontal" method="get" action="{!! route('lap_perbandingan_po_vendor') !!}">
        ...
        <div class="card-body">
            ...
            <div class="card-footer">
                <a href="{!! route('rangking_mitra') !!}" class="btn btn-danger btn-sm"><span class="fa fa-times"></span> Reset</a>
                                            ...
                                            <table id="exam" class="table table-hover text-nowrap" style="font-size: x-small">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Total Retur</th>
                                                        <th>Total</th>
                                                        <th>Rata2 Rupiah/Belanja Online</th>
                                                        <th>Rata2 Rupiah/Belanja Offline</th>
                                                        <th>Rata2 Rupiah/Retur</th>

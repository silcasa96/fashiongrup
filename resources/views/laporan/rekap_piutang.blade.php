...
@section('title', 'Rekap Piutang | Ethica')
@section('content')
<div class="card">
    @include('flash-message')
    <div class="card-header">
        <h1 class="card-title" style="float: left; font-size: 20pt">Rekap Piutang</h3>
    ...
    <form id="penjualan" class="form-horizontal" method="get" action="{!! route('lap_perbandingan_po_vendor') !!}">
        ...
        <div class="card-body">
            ...
            <div class="card-footer">
                <a href="{!! route('rekap_piutang') !!}" class="btn btn-danger btn-sm"><span class="fa fa-times"></span> Reset</a>
                                            ...
                                            <table id="exam" class="table table-hover text-nowrap" style="font-size: x-small">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Penjualan</th>
                                                        <th>Pembayaran</th>
                                                        <th>Lebih Bayar Diterima</th>
                                                        <th>Lebih Bayar Digunakan</th>
                                                        <th>Saldo Akhir</th>
                                                        <th>SA. Retur</th>
                                                        <th>SA. Komisi</th>
                                                        <th>SA. Piutang Retur</th>
                                                        <th>SA. Jatuh Jempo</th>
                                                        <th>Plafond</th>
                                                        <th>Nilai Pesanan</th>

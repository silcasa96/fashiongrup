...
@section('content')
    <div class="card">
        <div class="card-header">
            <h1 class="card-title" style="float: left; font-size: 16pt">Approve Desain</h1>
        </div>
        <div class="card-body">
            <form class="g-3" method="post" action="{!! route('update_appr_design',$design[0]->pr_design_id) !!}" onsubmit="return confirm('Apakah data akan diubah?');" enctype="multipart/form-data">
                @csrf
                <div class="row" style="font-size: smaller">
                    <div class="col-sm-6">
                        ...
                        <div class="col-md-12 d-inline-flex mb-2">
                            ...
                            <input type="text" class="form-control form-control-sm border-dark" value="{!! $design[0]->nmdesigner !!}" readonly>
                        </div>
                        <div class="col-md-12 d-inline-flex mb-2">
                        ...
                        <div class="col-md-12 d-inline-flex mb-2">
                            ...
                            <textarea type="text" class="form-control form-control-sm border-dark" rows="2" id="komentar" name="komentar" >{!! $design[0]->komentar !!}</textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-md-12 d-flex justify-content-end">
                    <a href="{{ route('appr_design') }}" type="submit" class="btn btn-secondary"><i class="ti ti-corner-up-left-double"></i> Kembali</a>
                </div>
            </form>
        </div>
    </div>

...
class KeuanganLapNetSalesHargaTransferController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.lap_net_sales_harga_transfer',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

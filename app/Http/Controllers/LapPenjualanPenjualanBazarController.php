...
class LapPenjualanPenjualanBazarController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.penjualan_bazar',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

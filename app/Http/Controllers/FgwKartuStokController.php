...
class FgwKartuStokController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.kartu_stok',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

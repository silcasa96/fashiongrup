...
class LaporanPerbandinganPoVendorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.laporan.lap_perbandingan_po_vendor',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

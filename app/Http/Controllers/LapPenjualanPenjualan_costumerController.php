...
class LapPenjualanPenjualan_costumerController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.penjualan_costumer',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

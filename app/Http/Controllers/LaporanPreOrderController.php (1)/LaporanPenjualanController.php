...
class LaporanPenjualanController extends Controller
{
    ...
    public function lap_penjualan()
    {
        ...
        return view('laporan.lap_penjualan',compact('customer','admin','sales','brand','gudang','keagenan','tipeproduk','tglawal','tglakhir','idcus','idadmin','idsales','idbrand','idgudang','idkeagenan','idtipeproduk'));
    }
...
ORDER BY nomor";
        ...
        if($request->get('Cari')=='Cari'){
            return view('laporan.lap_penjualan', compact('penjualan','customer','admin','sales','brand','gudang','keagenan','tipeproduk','tglawal','tglakhir','idcus','idadmin','idsales','idbrand','idgudang','idtipeproduk'));
        }

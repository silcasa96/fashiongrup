...
class FgwDataStokController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.data_stok',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

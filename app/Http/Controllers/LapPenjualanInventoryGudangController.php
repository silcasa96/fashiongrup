...
class LapPenjualanInventoryGudangController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.inventory_gudang',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

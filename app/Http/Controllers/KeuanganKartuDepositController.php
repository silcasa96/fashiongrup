...
class KeuanganKartuDepositController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.kartu_deposit',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

...
class LaporanBarmasProduksiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.lap_barmas_produksi',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

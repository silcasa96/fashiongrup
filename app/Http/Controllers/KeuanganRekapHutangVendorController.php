...
class KeuanganRekapHutangVendorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.rekap_hutang_vendor',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

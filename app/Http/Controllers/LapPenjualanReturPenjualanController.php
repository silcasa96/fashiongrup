...
class LapPenjualanReturPenjualanController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.lap_retur_penjualan',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

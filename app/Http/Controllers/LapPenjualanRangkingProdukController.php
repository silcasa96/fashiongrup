...
class LapPenjualanRangkingProdukController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.rangking_produk',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

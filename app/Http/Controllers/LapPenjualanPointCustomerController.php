...
class LapPenjualanPointCustomerController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.point_customer',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

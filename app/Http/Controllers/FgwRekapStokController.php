...
class FgwRekapStokController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.rekap_stok',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

...
class LapPenjualanPenyerapanProdukController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.lap_penyerapan_produk',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

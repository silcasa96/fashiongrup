...
class FgwDetailRekapStokController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.detail_rekap_stok',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

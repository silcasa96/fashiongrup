...
class LapPenjualanPenjualanAgenPusatController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.penjualan_agen_pusat',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}

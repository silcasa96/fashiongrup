...
class BarmasProdkusiVendorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('laporan.barmas_produksi_vendor',compact('brand','subbrand','artikel','vendor','gudang','tglawal','tglakhir','idartikel','idsubbrand','idbrand','idvendor','idgudang'));
    }
}
